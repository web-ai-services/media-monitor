...
Дашборды это наборы свободных карточек-визуализаций, в различных разрезах и типах, к примеру сверху изображены карточки гео-визуализации а внизу дашборд аналитики некого корпуса в разных критериях (непосредственно тональности)
